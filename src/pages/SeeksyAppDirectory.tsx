...
const APP_DETAILS: Record<string, { features: string[]; bestFor: string[]; tagline: string; longDescription: string }> = {
  ...
  "my-page": { tagline: "Build your personal landing page with drag-and-drop sections.", longDescription: "Create a beautiful, branded landing page that showcases your content, links, and CTA. Fully customizable with themes.", features: ["Drag-and-drop builder", "Custom themes", "Video header support", "CTA buttons", "Analytics tracking"], bestFor: ["Creators", "Influencers", "Personal brands"] },
  "identity-verification": { tagline: "Verify your voice and face on blockchain.", longDescription: "Secure your creator identity with voice and face verification. Manage usage rights and permissions on blockchain.", features: ["Voice verification", "Face verification", "Blockchain registry", "Usage rights management", "Verification badge"], bestFor: ["Creators", "Public figures", "Voice artists"] },
