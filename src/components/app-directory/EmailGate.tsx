  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto max-w-[620px] w-full text-center rounded-2xl px-8 py-12 sm:px-12 sm:py-16 bg-card/80 backdrop-blur-xl shadow-2xl border border-border/20"
      >
        {/* Eyebrow */}
        <motion.p
